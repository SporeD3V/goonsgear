<div class="relative overflow-hidden bg-black px-6 py-16 lg:py-20">
    ...
    <div class="pointer-events-none absolute inset-0 z-[1]" aria-hidden="true">
        {{-- Left-side flakes --}}
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="left:5%;width:36px;height:36px;opacity:.18;--snow-duration:12s;--snow-delay:0s;--snow-drift:20px;--snow-spin:180deg;--snow-sway-amount:14px;--snow-sway-speed:4s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="left:22%;width:28px;height:28px;opacity:.13;--snow-duration:16s;--snow-delay:1.5s;--snow-drift:-15px;--snow-spin:-120deg;--snow-sway-amount:10px;--snow-sway-speed:5s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="left:35%;width:32px;height:32px;opacity:.10;--snow-duration:14s;--snow-delay:3s;--snow-drift:25px;--snow-spin:240deg;--snow-sway-amount:12px;--snow-sway-speed:3.5s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="left:12%;width:24px;height:24px;opacity:.11;--snow-duration:18s;--snow-delay:2s;--snow-drift:-10px;--snow-spin:90deg;--snow-sway-amount:8px;--snow-sway-speed:6s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="left:28%;width:40px;height:40px;opacity:.08;--snow-duration:15s;--snow-delay:4s;--snow-drift:18px;--snow-spin:-200deg;--snow-sway-amount:11px;--snow-sway-speed:4.5s;">

        {{-- Right-side flakes --}}
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="right:6%;left:auto;width:32px;height:32px;opacity:.16;--snow-duration:13s;--snow-delay:0.5s;--snow-drift:-22px;--snow-spin:160deg;--snow-sway-amount:13px;--snow-sway-speed:4.2s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="right:20%;left:auto;width:26px;height:26px;opacity:.12;--snow-duration:17s;--snow-delay:2.5s;--snow-drift:12px;--snow-spin:-150deg;--snow-sway-amount:9px;--snow-sway-speed:5.5s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="right:34%;left:auto;width:36px;height:36px;opacity:.09;--snow-duration:11s;--snow-delay:1s;--snow-drift:-20px;--snow-spin:220deg;--snow-sway-amount:15px;--snow-sway-speed:3.8s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="right:14%;left:auto;width:24px;height:24px;opacity:.10;--snow-duration:19s;--snow-delay:3.5s;--snow-drift:15px;--snow-spin:-100deg;--snow-sway-amount:8px;--snow-sway-speed:6.2s;">
        <img src="{{ asset('images/snowgoons-snowflake.png') }}" alt="" class="snowflake-particle" style="right:4%;left:auto;width:30px;height:30px;opacity:.14;--snow-duration:14s;--snow-delay:0s;--snow-drift:-18px;--snow-spin:280deg;--snow-sway-amount:12px;--snow-sway-speed:4.8s;">
    </div>
