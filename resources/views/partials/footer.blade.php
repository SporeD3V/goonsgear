    ...
    <div class="mx-auto max-w-6xl px-6 pb-10 pt-16">
        ...
        <div class="flex flex-col items-center gap-8 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="#" aria-label="Pinterest" class="rounded-lg p-2.5 {{ $light ? 'text-black/40 transition-all duration-200 hover:bg-black/5 hover:text-black' : 'text-white/50 transition-all duration-200 hover:bg-white/10 hover:text-white' }}">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
