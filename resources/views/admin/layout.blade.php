            ...
            <aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-40 flex w-72 max-w-[88vw] -translate-x-full flex-col border-r border-stone-200 bg-stone-900 text-stone-300 transition-transform lg:w-60 lg:max-w-none lg:translate-x-0">
                ...
                <nav class="flex-1 overflow-y-auto px-3 py-4">
                    @php
                        ...
                        $inConfig = str_starts_with($currentRoute, 'admin.maintenance.integrations') || str_starts_with($currentRoute, 'admin.invoices.settings') || str_starts_with($currentRoute, 'admin.maintenance.abandoned-cart') || str_starts_with($currentRoute, 'admin.url-redirects');
                    ...
                    <a href="{{ route('admin.dashboard') }}"
                       class="mb-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ $currentRoute === 'admin.dashboard' ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                    ...
                    <div x-data="{ open: {{ $inStore ? 'true' : 'false' }} }" class="mt-5">
                        ...
                        <div x-show="open" x-transition.origin.top>
                            <a href="{{ route('admin.orders.index') }}"
                               class="mb-0.5 mt-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.orders') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.products.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.products') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.categories.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.categories') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.tags.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.tags') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                    ...
                    <div x-data="{ open: {{ $inPricing ? 'true' : 'false' }} }" class="mt-4">
                        ...
                        <div x-show="open" x-transition.origin.top>
                            <a href="{{ route('admin.coupons.index') }}"
                               class="mb-0.5 mt-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.coupons') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.bundle-discounts.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.bundle-discounts') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.regional-discounts.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.regional-discounts') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                    ...
                    <div x-data="{ open: {{ $inConfig ? 'true' : 'false' }} }" class="mt-4">
                        ...
                        <div x-show="open" x-transition.origin.top>
                            <a href="{{ route('admin.maintenance.integrations.edit') }}"
                               class="mb-0.5 mt-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.maintenance.integrations') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.invoices.settings.edit') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.invoices.settings') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                                <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Zm-3 13.5h6m-6 3h3"/></svg>
                                Invoices
                            </a>

                            <a href="{{ route('admin.maintenance.abandoned-cart.edit') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.maintenance.abandoned-cart') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                            ...
                            <a href="{{ route('admin.url-redirects.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.url-redirects') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
                    ...
                    <div x-data="{ open: {{ $inSystem ? 'true' : 'false' }} }" class="mt-4">
                        ...
                        <div x-show="open" x-transition.origin.top>
                            ...
                            <a href="{{ route('admin.maintenance.fallback-media.index') }}"
                               class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2.5 text-[15px] font-medium transition {{ str_starts_with($currentRoute, 'admin.maintenance.fallback-media') ? 'bg-[#36a2eb]/20 text-[#36a2eb]' : 'hover:bg-stone-800 hover:text-white' }}">
